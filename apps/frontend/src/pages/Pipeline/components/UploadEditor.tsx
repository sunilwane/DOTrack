        ...
        <div className="xl:col-span-2 space-y-6">
            <Skeleton isLoaded={!isLoading} width="100%" height="220px" className="rounded-xl">
                <div
                    ...
                    className={
                        `flex flex-col items-center gap-4 rounded-xl border-2 border-dashed px-6 py-8 cursor-pointer transition-colors ${isDragging ? 'border-primary bg-primary/5' : 'border-slate-300 dark:border-[#3b4354] bg-slate-50 dark:bg-slate-800/20 hover:border-primary'
                        }`
                    }
                >
            ...
            {!uploadState.content && (
                <Skeleton isLoaded={!isLoading} width="100%" height="300px" className="rounded-xl">
